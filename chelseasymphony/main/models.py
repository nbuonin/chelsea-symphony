...
class Concert(Page):
    ...
    def set_url_path(self, parent):
        ...
        # TODO: Rethink this, the implicit logic here is that the importer
        # script will provide a season when it creates a Concert, because
        # Concert Dates have yet to be created
